...
export const UNLOCK_CATALOG: UnlockDef[] = [
  { key: "first-visit", label: "Welcome Sticker", category: "badge", threshold: 1, emoji: "🌱", description: "Earned on your very first verified local visit." },
  { key: "sunglasses", label: "Sunshine Shades", category: "accessories", threshold: 2, emoji: "🕶️", description: "Visit 2 different local shops.", diceBearParam: { name: "accessories", value: "sunglasses" } },
