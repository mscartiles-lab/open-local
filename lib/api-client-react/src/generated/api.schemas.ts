...
export interface Vendor {
  ...
  /** @nullable */
  additionalLocations?: VendorAdditionalLocationsItem[] | null;
  createdAt: string;
...
export interface VendorInput {
  ...
  longitude?: number | null;
  /** @nullable */
  additionalLocations?: VendorInputAdditionalLocationsItem[] | null;
}

export type VendorUpdateAdditionalLocationsItem = {
  lat: number;
  lng: number;
  /** @nullable */
  label?: string | null;
